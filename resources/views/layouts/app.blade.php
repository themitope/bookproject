...
<head>
    ...
    <script src="{{ asset('js/sweetalert/package/dist/sweetalert2.min.js') }}" defer></script>
    ...
    <link href="{{ asset('js/sweetalert/package/dist/sweetalert2.min.css') }}" rel="stylesheet">
    <!-- Favicon -->
